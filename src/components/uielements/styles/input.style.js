...
const InputWrapper = (ComponentName) => styled(ComponentName)`
    &.ant-input {
        ...
        &:-internal-autofill-selected {
            -webkit-text-fill-color: ${palette("text", 1)};
            -webkit-box-shadow: 0 0 0px 1000px ${palette("primary", 17)} inset;
        }

        &.ant-input-disabled:-webkit-autofill:disabled,
        &:-webkit-autofill:disabled {
            -webkit-text-fill-color: ${palette("boxshadow", 0)};
            -webkit-box-shadow: 0 0 0px 1000px ${palette("grayscale", 10)} inset;
            cursor: not-allowed;
            user-select: none;
        }
...
const TextAreaWrapper = (ComponentName) => styled(ComponentName)`
    &.ant-input {
        ...
        &.ant-textarea-disabled:disabled,
        &:disabled {
            background-color: ${palette("grayscale", 10)};
            color: ${palette("boxshadow", 0)};
            cursor: not-allowed;
